...
.tools{{display:flex;gap:12px;align-items:center;margin:12px 0}}input,select{{border:1px solid #aeb8c5;border-radius:7px;padding:9px 11px;font:inherit;background:#fff}}input{{flex:1}}.chart{{width:100%;height:auto;display:block}}.period-badge{{display:inline-block;border-radius:999px;background:#e0f2fe;color:#075985;padding:2px 7px;margin-top:5px;font-size:.72rem;font-weight:700}}.center{{text-align:center;white-space:nowrap}}.sortable button{{width:100%;border:0;background:transparent;padding:0;color:inherit;font:inherit;font-weight:700;text-align:left;cursor:pointer;white-space:nowrap}}.sortable.numeric button{{text-align:right}}.sortable.center button{{text-align:center}}.sortable button::after{{content:" ↕";color:#64748b}}.sortable button[data-direction="asc"]::after{{content:" ↑"}}.sortable button[data-direction="desc"]::after{{content:" ↓"}}.th-group{{text-align:center;font-size:.82rem;letter-spacing:.04em}}.th-meta{{background:#f1f5f9;border-top:3px solid #64748b}}.th-supply-demand{{background:#e0f2fe;border-top:3px solid #0284c7}}.th-inbound{{background:#fff7ed;border-top:3px solid #f59e0b}}
